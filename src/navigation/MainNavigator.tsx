...
function CustomTabBar(
  props: BottomTabBarProps & { isLandscape: boolean; isLocalOnly: boolean },
) {
  const {
    state,
    descriptors,
      ...
      {state.routes.map((route, index) => {
        ...
        return (
          ...
          >
            ...
            <Text style={[styles.leftTabLabel, { color }]} numberOfLines={1}>
              {label}
            </Text>
          </Pressable>
        );
