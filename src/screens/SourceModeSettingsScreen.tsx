...
const SourceModeSettingsScreen = React.memo(
  function SourceModeSettingsScreen() {
    ...
    const { serverUrl, isAuthenticated, user, setServerUrl, login, logout } =
      useAuthStore();

    // Toggle states
    const [jellyfinEnabled, setJellyfinEnabled] = useState(
      sourceMode === "jellyfin" || sourceMode === "both",
    );
    const [localEnabled, setLocalEnabled] = useState(
      sourceMode === "local" || sourceMode === "both",
    );
    ...
    const [selectedLibs, setSelectedLibs] = useState<Set<string>>(
      new Set(selectedJellyfinLibraries),
    );
        ...
        try {
          ...
          if (response.Authenticated) {
            ...
            try {
              ...
              const authResult =
                await jellyfinApi.authenticateWithQuickConnect(secret);
              ...
              Alert.alert(
                "Error",
                "Quick Connect authorized, but failed to complete login.",
              );
              setShowQcModal(false);
            }
          }
              ...
              <View style={styles.cardHeader}>
                <View
                  style={[
                    ...
                    {
                      backgroundColor: jellyfinEnabled
                ...
                <Switch
                  value={jellyfinEnabled}
                  onValueChange={handleJellyfinToggle}
                />
              </View>
                      ...
                      {loadingLibraries ? (
                        ...
                        <View style={styles.librarySection}>
                          <View style={styles.librarySectionHeader}>
                            ...
                            <TouchableOpacity
                              onPress={handleSelectAllLibraries}
                            >
                              <Text
                                variant="labelSmall"
                                style={{ color: theme.colors.primary }}
                              >
                                {selectedLibs.size === musicLibraries.length
                                  ? "Deselect All"
                                  : "Select All"}
                              </Text>
                            </TouchableOpacity>
        ...
        <Modal visible={showQcModal} animationType="slide" transparent>
          ...
          >
            ...
            >
              ...
              >
                Enter this code in your Jellyfin dashboard or Quick Connect
                page:
              </Text>
