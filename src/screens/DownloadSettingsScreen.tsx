...
const DownloadSettingsScreen = React.memo(function DownloadSettingsScreen() {
    ...
    try {
      ...
      if (directory) {
        ...
        if (directory.exists) {
          ...
          showConfirmation(
            "Success",
            "Download location updated! Downloads will now save to this folder.",
            "success",
          );
        } else {
  ...
  const handleResetPath = () => {
    ...
    showConfirmation(
      "Reset",
      "Download location reset to app internal storage.",
      "info",
    );
  };
  ...
  const getConcurrentLabel = () => {
    return (
      CONCURRENT_OPTIONS.find((opt) => opt.value === maxConcurrentDownloads)
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <SettingsGroup title="Download Location">
            ...
            <View style={styles.buttonRow}>
              ...
              <Button mode="outlined" onPress={handleResetPath}>
                Reset
              </Button>
            </View>
            <Text
            ...
            >
              Select a folder to save downloaded music. Uses Android's Storage
              Access Framework for full access.
            </Text>
          </SettingsGroup>
          ...
          <SettingsGroup title="Simultaneous Downloads">
              ...
              >
                {CONCURRENT_OPTIONS.map((option) => (
                  <Menu.Item
                    ...
                    title={option.label}
                    leadingIcon={
                      maxConcurrentDownloads === option.value
                        ? "check"
                        : undefined
                    }
                  />
            ...
            >
              More simultaneous downloads complete faster but use more
              bandwidth.
            </Text>
          </SettingsGroup>
          ...
          <SettingsGroup title="Network">
            <SettingsItem
              ...
              description={
                wifiOnlyDownloads
                  ? "Downloads will wait for WiFi"
                  : "Downloads use any network"
              }
              icon="wifi"
