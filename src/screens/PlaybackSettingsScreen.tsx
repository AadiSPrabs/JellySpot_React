...
const PlaybackSettingsScreen = React.memo(function PlaybackSettingsScreen() {
    ...
    const { showTechnicalDetails, setShowTechnicalDetails } = useUISettingsStore();
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.content}>
          ...
          {audioQuality !== "lossless" && (
            ...
            >
              <Text style={{ color: theme.colors.error }} variant="bodySmall">
                Note: Transcoding requires permissions on your Jellyfin server.
                If playback fails, switch to Lossless.
              </Text>
            </View>
          )}
        </SettingsGroup>
          ...
          <SettingsItem
            ...
            right={() => (
              <Switch
                ...
                onValueChange={setShowTechnicalDetails}
              />
            )}
          />
        </SettingsGroup>
        ...
        <SettingsGroup title="Queue Management">
          ...
          >
            Limit the maximum number of tracks in the queue to improve
            performance on the queue page.
          </Text>
          <RadioButton.Group
            onValueChange={(value) => {
