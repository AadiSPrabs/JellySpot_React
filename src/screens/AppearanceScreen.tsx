...
import { useUISettingsStore, BackgroundType } from '../store/uiSettingsStore';
...
const BACKGROUND_OPTIONS: {
  ...
  { label: "Off", value: "off", description: "Use default dark background" },
  {
    label: "Blurred Image",
    value: "blurred",
    description: "Heavily blurred album artwork",
  },
  {
    label: "Dominant Color",
    value: "dominant",
    description: "Static gradient from artwork colors",
  },
];
...
const AppearanceScreen = React.memo(function AppearanceScreen() {
    ...
    const { backgroundType, themeColor, isAmoledMode, setBackgroundType, setThemeColor, setAmoledMode } = useUISettingsStore(useShallow(state => ({
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <SettingsGroup title="Display">
          <SettingsItem
            ...
            right={() => (
              <Switch value={isAmoledMode} onValueChange={setAmoledMode} />
            )}
          />
        </SettingsGroup>
      </ScrollView>
